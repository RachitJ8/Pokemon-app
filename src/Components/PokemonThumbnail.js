...
const PokemonThumbnail=({id,name,image,type,height,weight,stat1,stat2,stat3,stat4,stat5,stat6,bs1,bs2,bs3,
    ...
    const [show, setShow] = useState(false);
        console.log(height,weight,stat1,stat2,stat3,stat4,stat5,stat6,bs1,bs2,bs3,
            bs4,bs5,bs6)
    return(
        <div className={style}>
            ...
            <div className="detail-wrapper">
                ...
                {show===true?<Description className="desc" weightpok={weight} heightpok={height} pokstat1={stat1}
                pokstat2={stat2}
                pokstat3={stat3}
                pokstat4={stat4}
                pokstat5={stat5}
